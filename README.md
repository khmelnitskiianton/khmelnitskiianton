...
+ [Terminal emulator](https://github.com/khmelnitskiianton/terminal-emulator) - simple implementation of terminal `iksTerm` on X11 and hand-made shell `iksSh`.
+ [Mega Humidifier](https://github.com/khmelnitskiianton/mega-humidifier) - practical project of creating humidifier with designing PCB, 3D modeling, Laser cutting and Arduino programming.
+ [AsmCx86](https://github.com/khmelnitskiianton/AsmCx86)               - simple printf() on NASM and research project on optimizing the Mandelbrot set.
